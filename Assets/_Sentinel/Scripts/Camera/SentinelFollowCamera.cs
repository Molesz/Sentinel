...
public class SentinelKameraBeallitasok
{
    ...
    [Tooltip("Világkoordinátában értendõ. Y: a kép középpontjának magassága.")]
    ...
    [InspectorName("Függõleges simítás")]
    [Min(0.01f)]
    ...
    [InspectorName("Függõleges holtzóna")]
    [Tooltip("Az apró függõleges mozgásokat és kisebb ugrásokat tompítja.")]
    [Min(0f)]
    public float fuggolegesHoltzona = 0.35f;

    [Header("Elõretekintés")]

    [InspectorName("Elõretekintés távolsága")]
    [Min(0f)]
    public float eloretekintes = 0.65f;

    [InspectorName("Teljes elõretekintés sebessége")]
    [Tooltip("Ekkora karaktersebességnél éri el a teljes elõretekintést.")]
    [Min(0.01f)]
...
public class SentinelFollowCamera : MonoBehaviour
{
    ...
    [Tooltip(
        ...
        "Így annak mozgása nem számít a karakter saját elõretekintésébe."
    )]
    ...
    [Tooltip(
        "(0,0,0): negatív Z felõl néz +Z felé. " +
        "(5,0,0): enyhén felülrõl néz."
    )]
    ...
    [InspectorName("Elõretekintés simítása")]
    [Min(0.01f)]
    ...
    [InspectorName("Elõretekintés megtartása megálláskor")]
    ...
    [Tooltip(
        ...
        "a konténert, és a határok annak helyi koordinátáiban értendõk."
    )]
    ...
    [InspectorName("Alsó és felsõ határ")]
        ...
        float dt)
    {
        ...
        // Képkockasebességtõl független átmenet.
        ...
        // Új zónában a kisebb elõretekintési határt is betartja.
